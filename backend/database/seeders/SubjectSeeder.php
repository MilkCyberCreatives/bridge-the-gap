    ...
    public function run(): void
    {
        $items = [
            [
                ...
                'intro_title' => 'Mathematics support that improves confidence and results',
                'intro_text' => 'We help learners understand concepts clearly, practise effectively, and improve accuracy. Lessons focus on closing gaps, building speed, and preparing learners for tests and exams.',
                'outcomes' => [
                ...
                'faqs' => [
                    ['q' => 'Do you support CAPS and IB mathematics?', 'a' => 'Yes. Support is aligned to either CAPS or IB requirements.'],
                    ['q' => 'Can this be integrated with matric support?', 'a' => 'Yes. Mathematics tutoring and matric support can be combined.'],
                    ['q' => 'How do we start?', 'a' => 'Submit a booking request and we will recommend the best starting plan.'],
                ],
                'images' => [
            ...
            [
                ...
                'intro_title' => 'English skills that translate to better school performance',
                'intro_text' => 'We help learners strengthen comprehension, language use, writing quality, and exam responses. Support is practical, measurable, and aligned to curriculum outcomes.',
                'outcomes' => [
                ...
                'faqs' => [
                    ['q' => 'Do you support literature and writing?', 'a' => 'Yes. We support both literature and writing outcomes.'],
                    ['q' => 'Is support available for CAPS and IB English?', 'a' => 'Yes. We tailor support to the curriculum and assessment context.'],
                    ['q' => 'Can this run as a group intervention?', 'a' => 'Yes. Group English support can be delivered for school interventions.'],
                ],
                'images' => [
            ...
            [
                ...
                'tagline' => 'Understand concepts, apply formulas correctly, and prepare effectively for exams.',
                'intro_title' => 'Physical sciences support for stronger conceptual understanding',
                'intro_text' => 'We support learners with key physics and chemistry concepts, step-by-step calculations, and exam preparation. The process prioritises understanding first, then performance.',
                'outcomes' => [
                ...
                'faqs' => [
                    ['q' => 'Do you support both physics and chemistry?', 'a' => 'Yes. Physical sciences support includes both components.'],
                    ['q' => 'Is this available for matric rewrite learners?', 'a' => 'Yes. It can be integrated with matric support services.'],
                    ['q' => 'Do you support IB sciences?', 'a' => 'Yes. Support can be adapted for IB science pathways where needed.'],
                ],
                'images' => [
